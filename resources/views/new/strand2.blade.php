                            ...
                            <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item"
                                            ...
                                            class="dropdown-item"
                                            href="https://coreui.io/demos/bootstrap/4.2/free/#">Another action</a><a
                                            class="dropdown-item"
                                            href="https://coreui.io/demos/bootstrap/4.2/free/#">Something else here</a>
                                    </div>
                                </div>
                            </div>
                            <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                                <canvas class="chart" id="card-chart1" height="70" width="207"
                                    style="display: block; box-sizing: border-box; height: 70px; width: 207px;"></canvas>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card mb-4 text-white bg-info">
                            ...
                            <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                                <canvas class="chart" id="card-chart2" height="70" width="207"
                                    style="display: block; box-sizing: border-box; height: 70px; width: 207px;"></canvas>
                                <div class="chartjs-tooltip" style="opacity: 0; left: 86.6667px; top: 132.625px;">
                        ...
                        <div class="card mb-4 text-white bg-warning">
                            ...
                            <div class="c-chart-wrapper mt-3" style="height:70px;">
                                <canvas class="chart" id="card-chart3" height="70" width="239"
                                    style="display: block; box-sizing: border-box; height: 70px; width: 239px;"></canvas>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <td>
                                                    <div class="clearfix">
                                                        ...
                                                        <div class="float-end"><small
                                                                class="text-medium-emphasis">Jun
                                                                11, 2020 - Jul 10,
                                                                2020</small></div>
                                                    </div>
                                                    <div class="progress progress-thin">
