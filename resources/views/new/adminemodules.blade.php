                ...
                <div class="modal-body">
                    <div class="row">
                        <form action="{{ route('modules.store') }}?id={{ $id }}" method="POST"
                            ...
                            <div class="form-group">
                                <input required type="text"
                                    style="width:350px;margin-left: 35px;margin-bottom: 20px;" name="description"
                                    id="un" placeholder="E Module Description">
                            </div>
                            <div class="form-group" style="margin-left: 35px;margin-bottom: 20px;">
